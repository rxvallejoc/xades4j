...
public class PKIXCertificateValidationProviderTest
{
    ...
    public void testValidateMy() throws Exception
    {
        ...
        FileSystemDirectoryCertStore certStore = new FileSystemDirectoryCertStore(toPlatformSpecificFilePath("./src/test/resources/cert/my"));
        KeyStore ks = KeyStore.getInstance("jks");
        FileInputStream fis = new FileInputStream(toPlatformSpecificFilePath("./src/test/resources/cert/my/myStore"));
    ...
    public void testValidateNist() throws Exception
    {
        ...
        FileSystemDirectoryCertStore certStore = new FileSystemDirectoryCertStore("./src/test/resources/cert/csrc.nist");
        KeyStore ks = KeyStore.getInstance("jks");
        FileInputStream fis = new FileInputStream("./src/test/resources/cert/csrc.nist/trustAnchor");
