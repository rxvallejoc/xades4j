...
class XadesVerifierImpl implements XadesVerifier
{
            ...
            XMLSignature signature) throws XAdES4jException
    {
        ...
        Collection<PropertyInfo> verifyProperties = this.qualifyingPropertiesVerifier.verifyProperties(sigTsData, ctx);
        
        QualifyingProperty sigTs = verifyProperties.iterator().next().getProperty();
