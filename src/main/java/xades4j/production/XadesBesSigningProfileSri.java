 ...
 * @author Luís
 */
public final class XadesBesSigningProfileSri extends XadesSigningProfile
{
    public XadesBesSigningProfileSri(KeyingDataProvider keyingProvider)
    {
        super(keyingProvider);
    }

    public XadesBesSigningProfileSri(
